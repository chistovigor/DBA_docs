CREATE PROCEDURE "ROUTER"."SUB_FRAUD_ALTERT" IS
...
'DECLARE
 ...
 vC_REPORT := ''<HTML>''
  ...
  FOR TRXN IN (SELECT a.szdevin,o1.szname atm,o2.szname op,a.szpan,a.lamount/100 amt,a.lcurr,lpad(a.lresult,2,''0'') rc
                 FROM ' || vC_TABLE_NAME || ' a, objlist o1, objlist o2 -- ONLY FOR THIS F*CKING TABLE DYNAMIC SQL USED
 ...
 Arr_to := Mail_Pkg.ARRAY(''valexandrova@raiffeisen.ru'',
                          ...
                          ''DGOSTEV@raiffeisen.ru'',
                          ''vsevolod.golovatskikh@raiffeisen.ru'',
 ...
 Mail_Pkg.send( p_sender_email => ''LANIT-LIVE'',
                          p_from         => ''LANIT-LIVE'',
                          p_to           => Arr_to,
