Rem
Rem $Header: rdbms/admin/utlu112i.sql st_server_cmlim_11203_preupgrade_add_tablespace_sizing_fix/1 2012/05/01 18:10:02 cmlim Exp $
Rem
Rem utlu112i.sql
Rem
...
Rem    cmlim       04/25/12 - add tablespace sizing fixes on top of
Rem                         - 11203 release's pre-upgrade tool
...
-- *****************************************************************
  ...
  utlu_buildrev    CONSTANT VARCHAR2(3)  := '006';
