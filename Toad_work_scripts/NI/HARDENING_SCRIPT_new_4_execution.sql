...
-- IN case if Oracle XML Database will get invalidated check
-- Oracle XML Database (XDB) Installation on 12c - XDB invalid status after fresh installation/upgrade (Doc ID 2222780.1)

SET ECHO off FEEDBACK off TIMING ON SERVEROUTPUT ON TERMOUT On pagesize 0 linesize 200 heading on
SPOOL HARDENING_SCRIPT_new_4_execution.log
