OPTIONS (DIRECT=FALSE, PARALLEL=TRUE, ERRORS=1000, DISCARDMAX=1000, MULTITHREADING=TRUE)
LOAD DATA
INFILE '/mnt/oracle/temp/ONLINE_ARCHIVE/isslog_14.unl'
BADFILE '/mnt/oracle/temp/ONLINE_ARCHIVE/isslog_14.bad'
DISCARDFILE '/mnt/oracle/temp/ONLINE_ARCHIVE/isslog_14.dsc'
