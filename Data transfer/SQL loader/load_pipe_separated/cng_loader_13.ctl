OPTIONS (DIRECT=TRUE, PARALLEL=TRUE, ERRORS=1000, DISCARDMAX=1000, MULTITHREADING=TRUE)
LOAD DATA
INFILE '/mnt/oracle/temp/ONLINE_ARCHIVE/isslog_13.unl'
BADFILE '/mnt/oracle/temp/ONLINE_ARCHIVE/isslog_13.bad'
DISCARDFILE '/mnt/oracle/temp/ONLINE_ARCHIVE/isslog_13.dsc'
